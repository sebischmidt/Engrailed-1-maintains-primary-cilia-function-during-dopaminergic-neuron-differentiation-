---
title: "Report EN1 ko transcriptome analysis, Pathway enrichment analysis using DEGs for Overlap clones - unstimulated vs Wnt stimulated"
...
Overlap <- read.xlsx(file = "results/tables/DEGs_unstim-vs-stim.xlsx", sheetName = "Ctrl_unstim-vs-stim")
hom <- read.xlsx(file = "results/tables/DEGs_unstim-vs-stim.xlsx", sheetName = "EN1ko_unstim-vs-stim")

d <- Overlap[Overlap$symbol %in% hom$symbol,]
...
write.xlsx(ego_ALL, file = "results/tables/pathways_Overlap_unstim-vs-stim.xlsx", sheetName = "GO", row.names = FALSE)
...
p
emf("results/plots/Overlap_unstim-vs-stim_eGO_ALL.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
...
write.xlsx(ekegg, file = "results/tables/pathways_Overlap_unstim-vs-stim.xlsx", sheetName = "KEGG", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/Overlap_unstim-vs-stim_eKEGG.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
...
write.xlsx(ewp, file = "results/tables/pathways_Overlap_unstim-vs-stim.xlsx", sheetName = "WP", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/Overlap_unstim-vs-stim_eWP.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
...
#write.xlsx(ereactome, file = "results/tables/pathways_Overlap_unstim-vs-stim.xlsx", sheetName = "Reactome", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/Overlap_unstim-vs-stim_eReactome.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
