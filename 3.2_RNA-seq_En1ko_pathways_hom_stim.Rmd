---
title: "Report EN1 ko transcriptome analysis, Pathway enrichment analysis using DEGs of stimulated samples"
...
d <- read.delim("results/tables/DEGs_stim.txt", sep = "\t")
gene <- d$symbol
```
...
write.xlsx(ego_ALL, file = "results/tables/pathways_stim.xlsx", sheetName = "GO", row.names = FALSE, append = TRUE)
...
p
emf("results/plots/stim_eGO_ALL.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
...
write.xlsx(ekegg, file = "results/tables/pathways_stim.xlsx", sheetName = "KEGG", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/stim_eKEGG.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
...
write.xlsx(ewp, file = "results/tables/pathways_stim.xlsx", sheetName = "WP", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/stim_eWP.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
...
write.xlsx(ereactome, file = "results/tables/pathways_stim.xlsx", sheetName = "Reactome", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/stim_eReactome.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
