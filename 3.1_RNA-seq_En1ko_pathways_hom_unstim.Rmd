---
title: "Report EN1 ko transcriptome analysis, Pathway enrichment analysis using DEGs of unstimulated samples"
...
d <- read.delim("results/tables/DEGs_unstim.txt", sep = "\t")
gene <- d$symbol
```
...
write.xlsx(ego_ALL, file = "results/tables/pathways_unstim.xlsx", sheetName = "GO", row.names = FALSE, append = TRUE)
...
p
emf("results/plots/unstim_eGO_ALL.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
...
write.xlsx(ekegg, file = "results/tables/pathways_unstim.xlsx", sheetName = "KEGG", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/unstim_eKEGG.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
...
write.xlsx(ewp, file = "results/tables/pathways_unstim.xlsx", sheetName = "WP", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/unstim_eWP.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
...
write.xlsx(ereactome, file = "results/tables/pathways_unstim.xlsx", sheetName = "Reactome", row.names = FALSE, append = TRUE)
```
...
p
emf("results/plots/unstim_eReactome.emf",width = 10, height = 8, coordDPI = 400, family = "Arial") 
p
dev.off()
```
