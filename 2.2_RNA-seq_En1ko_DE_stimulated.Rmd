...
title: "Report EN1 ko transcriptome analysis, differential expression analysis for stimulated samples"
...
#filter for stimulated
count_matrix <- t(count_matrix)
sample_summary <- as.data.frame(t(sample_summary))

count_matrix <- t(count_matrix[sample_summary$stimulation == "stim",])
sample_summary <- t(sample_summary[sample_summary$stimulation == "stim",])

```

This is how the count matrix for only stimulated samples looks like (first 1000 rows, to speed things up):
...
This is how the sample matrix for only stimulated samples looks like
...
#write.table(res_hom_nested, "results/tables/stim_DEGs_full_hom_nested.txt", sep = "\t")
write.xlsx(res_hom_nested, file = "results/tables/DEGs_full_stim.xlsx", sheetName = "DEGs_stim", append = TRUE)
...
write.table(diff_exp_genes_hom_nested, "results/tables/DEGs_stim.txt", sep = "\t")
write.xlsx(diff_exp_genes_hom_nested, file = "results/tables/DEGs_stim.xlsx", sheetName = "DEGs_stim", append = TRUE)
...
emf("results/plots/Volcano_stim.emf", emfPlus= FALSE, coordDPI = 400, 
...
emf("results/plots/heatmap_stim_new.emf", emfPlus= FALSE, coordDPI = 400, 
